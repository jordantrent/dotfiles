...
```bash
python3 /Users/jordantrent/.local/share/opencode-insights/src/collector.py --days 14 -o /Users/jordantrent/.local/share/opencode-insights/output/raw_metrics.json
```

Read the output file to understand the raw data:
```bash
cat /Users/jordantrent/.local/share/opencode-insights/output/raw_metrics.json
```
...
Create `/Users/jordantrent/.local/share/opencode-insights/output/narratives.json` with this EXACT structure:
...
metrics = json.load(open('/Users/jordantrent/.local/share/opencode-insights/output/raw_metrics.json'))
narratives = json.load(open('/Users/jordantrent/.local/share/opencode-insights/output/narratives.json'))
...
with open('/Users/jordantrent/.local/share/opencode-insights/output/report_data.json', 'w') as f:
...
```bash
python3 /Users/jordantrent/.local/share/opencode-insights/src/generator.py --input /Users/jordantrent/.local/share/opencode-insights/output/report_data.json --output /Users/jordantrent/.local/share/opencode-insights/output/report.html
```
